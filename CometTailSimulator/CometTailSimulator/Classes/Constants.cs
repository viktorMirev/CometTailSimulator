namespace CometTailSimulator.Classes
{
    public abstract class Constants
    {
        ...
        public static readonly double A = 1;                 //the AVG albedo of the particles
        public static readonly double p = 1500;                 //the AVG density of the particles
        public static readonly double dayInS = 14400;          //the number of seconds in a day
        public static readonly int scale = 40000000;          //meters per pixl
        ...
        public static readonly double diffraction = 3;       //the +- angle when creating a line
